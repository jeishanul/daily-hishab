    ...
    <section>
        <div class="card">
            <div class="card-header d-flex align-items-center justify-content-between">
                <x-section-header title="{{ __('summary_report') }}" />
            </div>
        </div>
                ...
                <div class="col-md-3 mb-3">
                    <div class="colored-box d-flex flex-column h-100">
                        <div class="d-flex justify-content-between report-box-top w-100">
                            ...
                            <img src="{{ asset('public/icons/checklist.png') }}" alt="" class="report-section-card-image">
                        </div>
                ...
                <div class="col-md-3 mb-3">
                    <div class="colored-box d-flex flex-column h-100">
                        <div class="d-flex justify-content-between report-box-top w-100">
                            ...
                            <img src="{{ asset('public/icons/sales.svg') }}" alt="" class="report-section-card-image">
                        </div>
                        <div class="mt-3 w-100">
                            <div class="d-flex justify-content-between">
                                <div class="mt-2 report-section-card-text">{{ __('total_amount') }}</div>
                ...
                <div class="col-md-3 mb-3">
                    <div class="colored-box d-flex flex-column h-100">
                        <div class="d-flex justify-content-between report-box-top w-100">
                            ...
                            <img src="{{ asset('public/icons/cash.svg') }}" alt="" class="report-section-card-image">
                        </div>
                        <div class="mt-3 w-100">
                            <div class="d-flex justify-content-between">
                                <div class="mt-2 report-section-card-text">{{ __('total_amount') }}</div>
                ...
                <div class="col-md-3 mb-3">
                    <div class="colored-box d-flex flex-column h-100">
                        <div class="d-flex justify-content-between report-box-top w-100">
                            ...
                            <img src="{{ asset('public/icons/cup.svg') }}" alt="" class="report-section-card-image">
                        </div>
                        <div class="mt-3 w-100">
                            <div class="d-flex justify-content-between">
                                <div class="mt-2 report-section-card-text">{{ __('total_amount') }}</div>
