...
@section('content')
                    ...
                    <div class="d-flex gap-2">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                <a class="dropdown-item" href="{{ route('product.index') }}">{{ __('all_produts') }}</a>
                        ...
                        <button type="button" class="btn import-btn" data-toggle="modal"
                            data-target="#createImportModal"><i
                            ...
                            <tbody>
                                @foreach ($products as $product)
                                    <tr>
                                        ...
                                        <td><img src="{{ $product->media->file ?? asset('public/default/default.jpg') }}"
                                                ...
                                                <div class="dropdown-menu">
                                                    ...
                                                    @can('product.destroy')
                                                        <a href="{{ route('product.destroy', $product->id) }}"
                                                            class="dropdown-item productDeleteBtn"><i
                                    ...
                                    <div id="productDetails_{{ $product->id }}" data-backdrop="static" tabindex="-1"
                                        role="dialog" aria-labelledby="productDetailsModalLabel_{{ $product->id }}"
                                        aria-hidiven="true" class="modal fade text-left">
                                        <div role="document" class="modal-dialog modal-lg modal-dialog-centered">
                                            <div class="modal-content">
                                                <x-modal-header header="product_details"
                                                    id="productDetailsModalLabel_{{ $product->id }}" />
    ...
    <div id="createImportModal" tabindex="-1" role="dialog" data-backdrop="static"
        aria-labelledby="productImportModal" aria-hidden="true" class="modal fade text-left">
        <div role="document" class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <form action="{{ route('product.import') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <x-modal-header header="import_product" id="productImportModal" />
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12 mb-3">
                                <div class="form-group">
                                    <label class="mb-2">{{ __('import') }}<span class="text-danger">*</span></label>
