...
<head>
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('public/web/logos/fav-icon.png') }}">
            ...
            <table style="margin-top: 20px">
                <tbody>
                    <tr style="background-color:#ddd;">
                        ...
                        <td style="padding: 5px;width:30%;text-align:center">Discount:
                            {{ numberFormat($sale->coupon_discount) }}</td>
                    ...
                    <tr>
                        <td class="centered" colspan="3">Thank you for choosing {{ getSettings('site_title') ?? '' }}
                        </td>
                    </tr>
                </tbody>
            </table>
