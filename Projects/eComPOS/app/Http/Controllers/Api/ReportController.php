...
class ReportController extends Controller
{
    ...
    {
        $purchases = PurchaseRepository::getCurrentMonthPurchase();

        $sales = SaleRepository::getCurrentMonthSale();

        $transactions = TransactionRepository::getCurrntMonthCredit();

        $totalProductSales = ProductSaleRepository::getMonthlyTotalProductSales();
