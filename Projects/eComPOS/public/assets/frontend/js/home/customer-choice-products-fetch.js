$.ajax({
    url: "/ajax-customer-choice-products",
    type: "GET",
    success: function (response) {
        response.data.products.forEach(function (product, index) {
            ...
            $("#customer-choice-products").append(`
                <div class="col-xxl-3 col-lg-4 col-md-6 col-sm-6 my-3 ${isDisabled}">
                    <div class="card custom-card">
                        <div class="card-body position-relative">
                        <div class="new-label position-absolute wishlist-add-request" data-id="${product.id}">
                            ...
                            <div class="d-flex justify-content-between align-items-center gap-3 mt-3">
                                <div class="add-to-cart-button add-to-cart-request" data-id="${product.id}">
