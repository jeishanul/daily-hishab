...
use App\Http\Controllers\ManualInstallController;
...
Route::middleware(['auth', 'check_permission'])->group(function () {
    Route::get('/signout', [DashboardController::class, 'logout'])
        ->middleware('auth')
        ->name('signout');
    ...
    Route::controller(RoleController::class)->group(function () {
        ...
        Route::post('role/set-permission/{role}', 'setPermission')->name('role.set.permission');
    });
    // Unit
    ...
    Route::controller(CategoryController::class)->group(function () {
        ...
        Route::get('subcategories', 'subcategory')->name('category.subcategories');
        ...
        Route::get('category/print', 'category_print')->name('category.print');
    ...
    Route::controller(BannerController::class)->group(function () {
        ...
        Route::get('banner/status/change/{banner}', 'statusChange')->name('banner.status.change');
        Route::put('banner/update/{banner}', 'update')->name('banner.update');
        Route::get('banner/delete/{banner}', 'delete')->name('banner.delete');
    });
    //Brand
    ...
    Route::controller(SupplierController::class)->group(function () {
        ...
        Route::get('supplier/edit/{user}', 'edit')->name('supplier.edit');
        Route::put('supplier/update/{user}', 'update')->name('supplier.update');
        Route::get('supplier/destroy/{user}', 'destroy')->name('supplier.destroy');
    ...
    Route::controller(ProductController::class)
        ->group(function () {
            ...
            Route::get('product/generate-barcode', 'generateCode')->name('product.generate.code');
            Route::get('product/search', 'productSearch')->name('product.search');
            Route::get('product/select', 'productSelect')->name('product.select');
    ...
    Route::controller(CustomerController::class)->group(function () {
        ...
        Route::get('customer/edit/{user}', 'edit')->name('customer.edit');
        Route::put('customer/update/{user}', 'update')->name('customer.update');
        Route::get('customer/destroy/{user}', 'destroy')->name('customer.destroy');
    ...
    Route::controller(CustomerGroupController::class)->group(function () {
        ...
        Route::put('customer-group/update/{customerGroup}', 'update')->name('customer.group.update');
    ...
    Route::controller(SaleController::class)
        ->group(function () {
            ...
            Route::get('orders', 'orders')->name('sale.orders');
            Route::get('order/status/update/{sale}/{status}', 'orderStatus')->name('sale.order.status.update');
    ...
    Route::controller(ReportController::class)
        ->group(function () {
            ...
            Route::get('report/sales', 'sales')->name('report.sales');
            Route::get('report/purchases', 'purchases')->name('report.purchases');
            Route::get('purchases/print', 'purchasesPrint')->name('purchases.print');
            ...
            Route::get('expense/product', 'expensePrint')->name('expense.print');
        });
    //Sale Returns
    ...
    Route::controller(SettingsController::class)->group(function () {
        ...
        Route::get('mail-configuration', 'mailConfiguration')->name('mail.configuration.index');
        Route::post('mail-configuration/update', 'mailConfigurationUpdate')->name('mail.configuration.update');
        Route::get('database-backup', 'databaseBackup')->name('database.backup');
        Route::get('theme/update/{mode}', 'themeUpdate')->name('theme.update');
    });
    //Expense Category
    ...
    Route::controller(AccountsController::class)
        ->group(function () {
            ...
            Route::put('account/update/{account}', 'update')->name('account.update');
            Route::put('account/balance/{account}', 'updateBalance')->name('account.update.balance');
