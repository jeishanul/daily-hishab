...
return [
    'permissions' => [
        ...
        //User route
        'profile.index' => ['admin', 'store'],
        'profile.update' => ['admin', 'store'],
        'user.password' => ['admin', 'store'],
        //Sale route
        'sale.index' => ['admin', 'store'],
        'sale.draft' => ['admin', 'store'],
        'sale.orders' => ['admin', 'store'],
        'sale.order.status.update' => ['admin', 'store'],
        ...
        'report.purchases' => ['admin'],
        'purchases.print' => ['admin'],
        'report.sales' => ['admin'],
        'sale.print' => ['admin'],
        'report.product' => ['admin'],
        'product.print' => ['admin'],
        'report.expense' => ['admin'],
        'expense.print' => ['admin'],
        'report.profit.loss' => ['admin'],
        //Sale Return Route
        ...
        // Language
        'language.index' => ['admin'],
        'language.create' => ['admin'],
        'language.store' => ['admin'],
        'language.edit' => ['admin'],
        'language.update' => ['admin'],
        'language.delete' => ['admin'],
        //Settings route
        'settings.index' => ['admin'],
        'settings.update' => ['admin'],
        'mail.configuration.index' => ['admin'],
        'mail.configuration.update' => ['admin'],
