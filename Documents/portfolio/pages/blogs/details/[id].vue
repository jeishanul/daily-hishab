<template>
    <div>
        <!--================ Start Banner Area =================-->
        <BannerSection heading="Blog Details" routeName="blogs" subHeading="Blog Details" subRouteName="blogs/details/1" />
        <!--================ End Banner Area =================-->
                        ...
                        <div class="single-post row">
                            <div class="col-lg-12">
                                <div class="feature-img">
                                    <img class="img-fluid" src="~/assets/images/blog/feature-img1.jpg" alt="">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <img class="img-fluid" src="~/assets/images/blog/post-img1.jpg" alt="">
                                    </div>
                                    <div class="col-6">
                                        <img class="img-fluid" src="~/assets/images/blog/post-img2.jpg" alt="">
                                    </div>
                        ...
                        <div class="navigation-area">
                            <div class="row">
                                <div
                                    ...
                                    <div class="thumb">
                                        <a href="#"><img class="img-fluid" src="~/assets/images/blog/prev.jpg"
                                                alt=""></a>
                                    </div>
                                    <div class="arrow">
                                ...
                                <div
                                    ...
                                    <div class="thumb">
                                        <a href="#"><img class="img-fluid" src="~/assets/images/blog/next.jpg"
                                                alt=""></a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="comments-area">
                            ...
                            <div class="comment-list">
                                <div class="single-comment justify-content-between d-flex">
                                    <div class="user justify-content-between d-flex">
                                        <div class="thumb">
                                            <img src="~/assets/images/blog/c4.jpg" alt="">
                                        </div>
                                        <div class="desc">
                            ...
                            <div class="comment-list">
                                <div class="single-comment justify-content-between d-flex">
                                    <div class="user justify-content-between d-flex">
                                        <div class="thumb">
                                            <img src="~/assets/images/blog/c5.jpg" alt="">
                                        </div>
                                        <div class="desc">
